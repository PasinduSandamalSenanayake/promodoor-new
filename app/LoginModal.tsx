...
// Define the props so we can pass the close function from the main page
...
export default function LoginModal({ onClose }: LoginModalProps) {
  ...
  return (
    // 1. Added onClick={onClose} to close when clicking the dark background
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 font-sans text-white"
      onClick={onClose}
    >
      
      {/* 2. Added stopPropagation so clicking the form DOESN'T close the modal */}
      <div 
        className="flex w-full max-w-[800px] h-auto md:h-[600px] bg-[#1E293B] rounded-2xl shadow-2xl overflow-hidden border border-white/5 relative"
      ...
      >
        ...
        <div className="flex flex-col w-full md:w-1/2 p-8 md:p-12 relative">
