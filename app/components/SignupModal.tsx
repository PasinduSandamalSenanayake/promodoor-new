...
const handleSignup = async (e: React.FormEvent) => {
  ...
  return (
    <div 
      ...
      onClick={onClose}
    >
      {/* FIXED: Changed to min-h-[650px] and h-auto to prevent cut-offs */}
      <div 
        className="flex w-full max-w-[800px] h-auto md:min-h-[650px] md:h-auto bg-[#1E293B] rounded-2xl shadow-2xl overflow-hidden border border-white/5 relative"
      ...
      >
        ...
        {/* Added overflow-y-auto just in case the user has a very small laptop screen */}
        <div className="flex flex-col w-full md:w-1/2 p-8 md:p-12 relative overflow-y-auto max-h-[90vh]">
          ...
          <div className="mb-6 mt-4 md:mt-0">
            ...
            <p className="text-sm text-white/60">Enter your details to get started</p>
          </div>

          <form onSubmit={handleSignup} className="flex-1 flex flex-col">
            {/* FIXED: Reduced space-y-5 to space-y-4 so it fits better */}
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#334155] text-white border border-white/10 rounded-lg px-4 py-2.5 outline-none focus:ring-2 focus:ring-[#6366F1] transition"
                  required
                />
              </div>
            ...
            <p className="text-center text-sm text-white/60 mt-6 pb-4">
              Already have an account? <button type="button" className="text-[#6366F1] hover:underline" onClick={onClose}>Sign in</button>
            </p>
          </form>
        </div>
      </div>
